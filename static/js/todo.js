$(document).ready(function(){
  $(".task_content").click(function(){
    ...
    edit_todo_attr = 'edit_'+task_id;
    old_content = $(this).text();
   // $(this).empty();
//    element = "<input type='text' name='task' value='todo.task' id='edit_todo'>".replace(/todo.task/, old_content);
//
//    element.replace(/edit_todo/, edit_todo_attr);
//    alert(element);
    //$(this).append(element);
  });
});
